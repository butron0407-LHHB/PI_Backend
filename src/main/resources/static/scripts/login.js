...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function obtenerRutaSegunRol(rolIdentifier) {
        ...
        if (esAdmin) {
            ...
            // Si estamos ya en una subcarpeta, la ruta es solo admin.html (Relativa)
            return estamosEnRaiz ? '../paginas/admin.html' : '../paginas/admin.html';
        } else {
    ...
    loginButton.addEventListener('click', async (event) => {
        ...
        try {
            ...
            console.log('Login Exitoso. Rol obtenido:', sesion.rol);
